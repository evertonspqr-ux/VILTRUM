        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {characters.map((char, i) => (
            <motion.div
              ...
              className="group relative bg-space-black border border-steel-gray/20 overflow-hidden hover:border-steel-gray/60 transition-all duration-300 shadow-lg hover:shadow-[0_20px_40px_rgba(0,0,0,0.8)] z-10 hover:z-20"
            >
              {/* Image Section */}
              <div className="relative h-80 w-full overflow-hidden bg-gradient-to-t from-background to-space-black">
                <img 
                  src={char.image} 
                  alt={char.name}
                  className="w-full h-full object-cover object-top filter grayscale-[50%] group-hover:scale-110 group-hover:grayscale-0 transition-all duration-700 opacity-70 group-hover:opacity-100"
                  onError={(e) => {
                ...
                {/* Colored Overlay to give it a techy feel which fades on hover */}
                ...
                {/* Tech overlay */}
                <div className="absolute top-4 left-4 font-mono text-[10px] text-imperial-white/50 bg-black/50 px-2 py-1 border border-white/10 backdrop-blur-sm shadow-md group-hover:bg-blood-red/20 group-hover:text-imperial-white transition-colors duration-300">
              ...
              <div className="p-6 relative z-10 bg-space-black">
                <h4 className="text-3xl font-display font-bold text-imperial-white uppercase mb-1">{char.name}</h4>
                <p className="text-sm font-mono text-steel-gray tracking-wider mb-4 border-b border-steel-gray/20 pb-4">
                  {char.role}
                </p>
                ...
                <div className="bg-background border-l-2 border-blood-red/50 p-4 relative">
