      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          {stats.map((stat, i) => (
            <motion.div
              ...
              className="p-6 bg-space-black border border-steel-gray/20 relative shadow-md hover:shadow-xl hover:border-steel-gray/50 transition-all duration-300 cursor-default"
            >
              ...
              <p className={`font-display font-bold text-4xl mb-4 ${stat.color}`}>
                <AnimatedCounter target={stat.val} duration={2200} />
              </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <div className="w-full h-2 bg-background border border-steel-gray/20 mb-6">
                  <motion.div
                    className="h-full bg-scourge-green"
                    initial={{ width: 0 }}
          ...
          >
            ...
            <p className="font-display font-black text-6xl text-imperial-white drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]">
              <AnimatedCounter target="37" duration={2500} />
            </p>
